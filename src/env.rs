...
impl Env {
	...
	/// Returns a new environment which wraps and takes ownership of the
	/// provided raw environment.
	///
	/// # Safety
	///
	...
	/// class provides many extension points for low-level database subsystems,
