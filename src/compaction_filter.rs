...
pub trait CompactionFilter {
	...
	/// want to use compaction filter and whether you are using it in a safe
	/// way.
	///
...
///
///  See [Options::set_compaction_filter][set_compaction_filter] for more
/// details
///
///  [set_compaction_filter]:
/// ../struct.Options.html#method.set_compaction_filter
